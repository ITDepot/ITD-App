...
#define kVRGCalendarViewTopBarHeight 10
#define kVRGCalendarViewWidth 288

#define kVRGCalendarViewWidthiPad 768

#define kVRGCalendarViewDayWidth 24
#define kVRGCalendarViewDayHeight 24
